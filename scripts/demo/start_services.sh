...
echo "[SERVICE] Run alert delivery in another terminal:"
echo "[SERVICE] ./scripts/demo/run_alert_delivery.sh"
...
echo "[SERVICE] Future/optional tenant portal, not used in the main demo:"
